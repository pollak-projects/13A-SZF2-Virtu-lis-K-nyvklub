<template>
      ...
      <div class="upload-tvshow">
        ...
        <form @submit.prevent="submitTVShow" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="number" id="releaseYear" v-model="tvShow.releaseYear" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea id="description" v-model="tvShow.description" required></textarea>
          </div>
          <div class="form-group">
  ...
  const submitTVShow = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:3300/tvshows/upload', formData, {
        headers: {
